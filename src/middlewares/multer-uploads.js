...
const IMAGE_MIMETYPES = ["image/jpeg", "image/png", "image/jpg", "image/webp", "image/avif"];
...
export const uploadPostPicture = createMulterConfig("../../public/uploads/post-pictures", IMAGE_MIMETYPES);